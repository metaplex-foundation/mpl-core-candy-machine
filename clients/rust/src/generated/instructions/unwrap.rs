...
/// `unwrap` CPI instruction builder.
pub struct UnwrapCpiBuilder<'a> {
    instruction: Box<UnwrapCpiBuilderInstruction<'a>>,
}

impl<'a> UnwrapCpiBuilder<'a> {
...
struct UnwrapCpiBuilderInstruction<'a> {
