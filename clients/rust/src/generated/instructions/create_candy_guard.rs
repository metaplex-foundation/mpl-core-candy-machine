...
impl CreateCandyGuard {
    #[allow(clippy::vec_init_then_push)]
    pub fn instruction(
        &self,
        args: CreateCandyGuardInstructionArgs,
        ...
        let mut data = CreateCandyGuardInstructionData::new().try_to_vec().unwrap();
...
impl CreateCandyGuardInstructionData {
    fn new() -> Self {
        Self {
...
pub struct CreateCandyGuardInstructionArgs {
    pub data: Vec<u8>,
}

/// Instruction builder.
#[derive(Default)]
pub struct CreateCandyGuardBuilder {
...
impl CreateCandyGuardBuilder {
    ...
    pub fn build(&self) -> solana_program::instruction::Instruction {
        ...
        let args = CreateCandyGuardInstructionArgs {
...
/// `create_candy_guard` CPI instruction.
pub struct CreateCandyGuardCpi<'a> {
    /// The program to invoke.
    pub __program: &'a solana_program::account_info::AccountInfo<'a>,

    pub candy_guard: &'a solana_program::account_info::AccountInfo<'a>,

    pub base: &'a solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: CreateCandyGuardInstructionArgs,
}

impl<'a> CreateCandyGuardCpi<'a> {
...
/// `create_candy_guard` CPI instruction builder.
pub struct CreateCandyGuardCpiBuilder<'a> {
    instruction: Box<CreateCandyGuardCpiBuilderInstruction<'a>>,
}

impl<'a> CreateCandyGuardCpiBuilder<'a> {
    pub fn new(program: &'a solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CreateCandyGuardCpiBuilderInstruction {
            __program: program,
            candy_guard: None,
            base: None,
            authority: None,
    ...
    #[inline(always)]
    pub fn base(&mut self, base: &'a solana_program::account_info::AccountInfo<'a>) -> &mut Self {
    ...
    #[allow(clippy::clone_on_copy)]
    pub fn build(&self) -> CreateCandyGuardCpi<'a> {
        let args = CreateCandyGuardInstructionArgs {
...
struct CreateCandyGuardCpiBuilderInstruction<'a> {
    __program: &'a solana_program::account_info::AccountInfo<'a>,
    candy_guard: Option<&'a solana_program::account_info::AccountInfo<'a>>,
    base: Option<&'a solana_program::account_info::AccountInfo<'a>>,
